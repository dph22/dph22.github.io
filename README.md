...
**Programming/ software:** Processing, Python, Java, C+, CSS, Adobe (Photoshop, Illustrator, InDesign, Premiere, XD); 3D modelling (Blender, AutoCAD, 3ds Max, SketchUp); GIS and open data.

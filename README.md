...
**Programming/ software:** Processing, Python, R, Java, C+, CSS, HTML, MatLab; Tableau and Adobe (Photoshop, Illustrator, InDesign, Premiere, XD); 3D modelling (Rhino, Grasshopper, Unity, Blender, AutoCAD, 3ds Max, SketchUp); Nvivo, Miro, Canva, Wordpress, GIS, and interest in further developing VR and open data tools.
